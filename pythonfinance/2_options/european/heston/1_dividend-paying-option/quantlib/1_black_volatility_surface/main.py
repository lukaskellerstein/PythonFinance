...
# create the Matrix of implied Volatilities
...
# ex. now I can directly calculate implied volatility for given strike and expiration
strike = 600.0
expiry = 1.2  # years
...
# ------------------------------------------------
# -----------------------------------------------
# PLOT 1 - Given an expiry, we can visualize the volatility as a function of the strike.
# -----------------------------------------------
# -----------------------------------------------
strikes_grid = np.arange(strikes[0], strikes[-1], 10)
expiry = 1.0  # years
implied_vols = [
    black_var_surface.blackVol(expiry, s) for s in strikes_grid
...
# ------------------------------------------------
# -----------------------------------------------
# PLOT 2 - The whole volatility surface for all strikes and all expirations
# -----------------------------------------------
# -----------------------------------------------
...
Z = np.array(
    [black_var_surface.blackVol(y, x) for xr, yr in zip(X, Y) for x, y in zip(xr, yr)]
