...
# -------------------------------------------------------------------------
# Local volatility surface (based on Black Surface)
# -------------------------------------------------------------------------
black_var_surface = ql.BlackVarianceSurface(
    calculation_date, calendar, expiration_dates, strikes, implied_vols, day_count
)
local_vol_surface = ql.LocalVolSurface(
    ql.BlackVolTermStructureHandle(black_var_surface), flat_ts, dividend_ts, spot
)
...
Z = np.array(
    [local_vol_surface.localVol(y, x) for xr, yr in zip(X, Y) for x, y in zip(xr, yr)]
